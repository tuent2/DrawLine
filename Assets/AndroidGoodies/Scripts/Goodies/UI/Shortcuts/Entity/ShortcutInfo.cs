namespace DeadMosquito.AndroidGoodies.Internal
{
	...
	public class ShortcutInfo
	{
		...
		{
			return
				$"DisabledMessage: {DisabledMessage}, DisabledReason: {DisabledReason}, Id: {Id}, LastChangedTimestamp: {LastChangedTimestamp}, LongLabel: {LongLabel}, Package: {Package}, Rank: {Rank}, ShortLabel: {ShortLabel}, HasKeyFieldsOnly: {HasKeyFieldsOnly}, IsDeclaredInManifest: {IsDeclaredInManifest}, IsDynamic: {IsDynamic}, IsEnabled: {IsEnabled}, IsImmutable: {IsImmutable}, IsPinned: {IsPinned}";
		}
	}
}